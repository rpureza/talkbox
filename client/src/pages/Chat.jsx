...
const styles = {
  ...
  addBtn: { background: "#e94560", color: "white", border: "none", borderRadius: "50%",
    width: "24px", height: "24px", cursor: "pointer", fontSize: "18px", lineHeight: "1" },
  createRoom: { padding: "0.75rem", borderBottom: "1px solid #1e1e35", display: "flex", gap: "8px" },
  roomInput: { flex: 1, padding: "0.5rem", borderRadius: "4px", border: "1px solid #333",
    backgroundColor: "#0f0f1a", color: "white", fontSize: "13px" },
